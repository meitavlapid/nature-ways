          ...
          <div className="team-cards">
            ...
            <div className="team-card">
              ...
              <p>
                ...
                בגישה ממוקדת וביצועים שמניעים תהליכים קדימה – כל הדרך מהמחשבה
                עד למוצר המוגמר.
              </p>
            </div>
            <div className="team-card">
              ...
              <h4> יועצת מדעית בכירה לפיתוח רכיבים טבעיים</h4>
              <p>
                מדענית מובילה בתחומה, העוסקת בקידום פריצות דרך בתחום החומרים
                הפעילים מהטבע, בדגש על אצות. ד"ר אבני עומדת בראש קבוצת המחקר
                Algae4IBD, שפועלת לפיתוח רכיבים חדשניים בעלי השפעה ביולוגית
                מוכחת. בעלת רקורד עשיר של שיתופי פעולה בינלאומיים, ודמות מרכזית
                במספר פרויקטים זוכי מענקי Horizon 2020 של האיחוד האירופי. כאות
                הוקרה על תרומתה המדעית, זכתה באות הכבוד "חמסה" מטעם משרד
                המדע והטכנולוגיה
              </p>
            </div>
            <div className="team-card">
              ...
              <p>
                ...
                שילוב ייחודי של מדע, דיוק וחדשנות – בדרך
                לפורמולציות אפקטיביות באמת.
              </p>
            </div>
          </div>
        </div>
